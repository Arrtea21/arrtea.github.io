...
export default function Home(){
    return(
        <>
            ...
            <Links></Links>
            <div>
                <p className='d-flex align-items-center justify-content-center p-4 py-0 mb-0 text-center w-100 text-white' style={{backgroundColor:"black",fontFamily: "monospace"}}>Hey there, I'm Arrtea, but Tea works just fine.</p>
                <p className='d-flex align-items-center justify-content-center pb-4 mb-0 text-center w-100 text-white' style={{backgroundColor:"black",fontFamily: "monospace"}}>
